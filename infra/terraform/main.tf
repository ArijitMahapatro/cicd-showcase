terraform {
  ...
  # Remote state — replace bucket/region with your own
  # Uncomment when deploying for real
  # backend "s3" {
  #   bucket         = "your-terraform-state-bucket"
  #   key            = "cicd-showcase/terraform.tfstate"
  #   region         = "us-east-1"
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  comment             = "CI/CD Showcase Frontend - ${var.environment}"
